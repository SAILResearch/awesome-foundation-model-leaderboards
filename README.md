...
| [SecLens](https://github.com/mattersec-labs/seclens) | SecLens is a benchmark for evaluating LLMs on security vulnerability detection using 406 real CVE tasks across 35 dimensions, providing 5 role-specific leaderboards for security stakeholders. |
