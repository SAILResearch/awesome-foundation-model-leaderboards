...
| [SWE-Agent-Arena](https://github.com/Software-Engineering-Arena/SWE-Agent-Arena) | An open-source platform for evaluating CLI coding agents on real software engineering tasks with blind pairwise comparison and rich leaderboard metrics including Elo, Bradley-Terry MLE, PageRank, and consistency scores. |
| [SWE-Chatbot-Arena](https://github.com/Software-Engineering-Arena/SWE-Chatbot-Arena) | An open-source arena for evaluating LLMs on real software engineering tasks with multi-round conversations and repo context injection. |
| [SWE-Issue](https://github.com/Software-Engineering-Arena/SWE-Issue) | Ranks AI agents by their real-world GitHub issue resolution performance based on issue statistics from public repositories. |
| [SWE-Model-Arena](https://github.com/Software-Engineering-Arena/SWE-Model-Arena) | Evaluates tool-calling models head-to-head on real SE tasks with identical scaffolding and environments, only the underlying model varies. |
| [SWE-PR](https://github.com/Software-Engineering-Arena/SWE-PR) | Ranks AI agents by their real-world GitHub pull request acceptance rate, tracking merged PRs from public contributions over the last 6 months. |
