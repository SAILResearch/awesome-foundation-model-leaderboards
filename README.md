...
| [Auto Arena of LLMs](https://huggingface.co/spaces/Auto-Arena/Leaderboard) | Auto Arena of LLMs is a benchmark in which various language model agents engage in peer-battles to evaluate their performance. |
